...
CREATE OR REPLACE FUNCTION pg_enc_int4_get(enc_int4)
RETURNS enc_int4
AS 'MODULE_PATHNAME'
LANGUAGE C IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION pg_enc_int4_dump()
RETURNS void
AS 'MODULE_PATHNAME'
LANGUAGE C IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION pg_enc_int4_trigget()
RETURNS trigger
AS 'MODULE_PATHNAME'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pg_enc_float4_dump()
RETURNS void
AS 'MODULE_PATHNAME'
LANGUAGE C IMMUTABLE STRICT;
